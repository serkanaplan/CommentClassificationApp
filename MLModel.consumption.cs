...
namespace ClassificationApp
{
    public partial class MLModel
    {
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Durum");
            if (labelColumn == null)
            {
                throw new Exception("Durum column not found. Make sure the name searched for matches the name in the schema.");
            }
